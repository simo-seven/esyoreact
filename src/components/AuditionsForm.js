        ...
        <div className="wow fadeInUp" data-wow-delay="0.3s">
          ...
          >
            <div className="row g-3">
              ...
              <div className="col-md-12">
                <div className="form-floating">
                  <select className="form-control" name="instrument[]" required>
                    <option value="Violin">Violin</option>
                    <option value="Viola">Viola</option>
                    <option value="Cello">Cello</option>
                    <option value="Doublebass">Double Bass</option>
                    <option value="FlutePiccolo">Flute/Piccolo</option>
                    <option value="Oboe/EnglishHorn">Oboe/English Horn</option>
              ...
              <div className="col-md-12">
                <div className="form-check mb-3">
                  ...
                  <label className="form-check-label" htmlFor="gdprConsent">
                    ...
                    processing of my personal data and with being contacted.
                    Data is stored on ESYO infrastructure for organizational and
                    administrative purposes until it is deleted.
                  </label>
                </div>
              </div>
